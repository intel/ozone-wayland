...
class OzonePlatformWayland : public OzonePlatform {
 public:
  ...
  void InitializeUI() override {
    ...
    window_host_manager_.reset(new ui::DrmWindowHostManager());
    cursor_.reset(new ui::DrmCursor(window_host_manager_.get()));
 ...
 private:
  ...
  scoped_ptr<ui::DrmWindowHostManager> window_host_manager_;
